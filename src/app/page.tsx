...
/**
 * The intro and trust strip are static server-rendered markup; CalculatorLanding
 * only decides whether the intro is on screen, and keeps <header>/<main>/<footer>
 * as siblings so each maps to its landmark role.
 */
